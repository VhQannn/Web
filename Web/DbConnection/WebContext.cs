...
public partial class WebContext : DbContext
{
    ...
    public virtual DbSet<SupporterInsurancePackage> SupporterInsurancePackages { get; set; }
    ...
    public virtual DbSet<UserSupporterInsurance> UserSupporterInsurances { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=Hello;Database=Web;uid=sa;pwd=123;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SupporterInsurancePackage>(entity =>
        {
            entity.HasKey(e => e.PackageId).HasName("PKSupporte3213E83FF87F1525");

            entity.ToTable("Supporter_Insurance_Packages");
        ...
        {
            entity.HasKey(e => e.UserSupporterInsuranceId).HasName("PKUser_Sup3213E83F1BFC9F94");

            entity.ToTable("User_Supporter_Insurance");

            entity.Property(e => e.UserSupporterInsuranceId).HasColumnName("user_supporter_insurance_id");
            entity.Property(e => e.EndDate)
                .HasColumnType("datetime")
                .HasColumnName("end_date");
            entity.Property(e => e.PackageId).HasColumnName("package_id");
            ...
            entity.HasOne(d => d.Package).WithMany(p => p.UserSupporterInsurances)
                .HasForeignKey(d => d.PackageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FKUser_Supppacka1332DBDC");

            entity.HasOne(d => d.User).WithMany(p => p.UserSupporterInsurances)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FKUser_Suppuser_123EB7A3");
        });
        ...
        {
            entity.HasKey(e => e.VirtualCurrencyId).HasName("PK__VirtualC__75CDC725BBF45F65");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.VirtualCurrencies)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__VirtualCu__user___3B40CD36");
        });

        modelBuilder.Entity<VirtualCurrencyTransaction>(entity =>
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__VirtualC__55433A6B3DE769FA");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.VirtualCurrencyTransactions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__VirtualCu__user___3C34F16F");
        });

        modelBuilder.Entity<WithdrawalRequest>(entity =>
        {
            entity.HasKey(e => e.WithdrawalRequestId).HasName("PK__Withdraw__FD8AA1F29EABF47B");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.WithdrawalRequests)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Withdrawa__user___3D2915A8");
        });
