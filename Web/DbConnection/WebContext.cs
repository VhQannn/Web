...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AssignmentId).HasName("PK__Assignme__DA8918140251A901");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__Comments__E7957687536D8DCD");
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__Courses__8F1EF7AE2CEB6E3D");
        ...
        {
            entity.HasKey(e => e.ParentCommentId).HasName("PK__Parent_C__D23CEB6DA7987CBA");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__ED1FC9EA5BA9EA67");
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__Posts__3ED78766F91C7C55");
        ...
        {
            entity.HasKey(e => e.PostCategoryId).HasName("PK__Post_Cat__B2316F1221DC5796");
        ...
        {
            entity.HasKey(e => e.PurchaseId).HasName("PK__Purchase__87071CB930DE32E5");
        ...
        {
            entity.HasKey(e => e.RatingId).HasName("PK__Ratings__D35B278B6584B128");
        ...
        {
            entity.HasKey(e => e.ToolId).HasName("PK__Tools__28DE264F1B185B1D");
        ...
        {
            entity.HasKey(e => e.ToolCategoryId).HasName("PK__Tool_Cat__77A0093DE8649FC3");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370FC4E40785");
        ...
        {
            entity.HasKey(e => e.UserToolId).HasName("PK__User_Too__2ED437F390EEE9FF");
